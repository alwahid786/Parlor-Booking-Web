...
<head>
    ...
    <link rel="icon" type="image/gif/png" href="{{ asset('assets\images\home_page_component/favicon.png') }}">
    ...
    /* All Salons Sections Styling By Wahid - START */
    .br_20px-s {
        border-radius: 20px
    }
    ...
    /* All Salons Sections Styling By Wahid - END */
    </style>
</head>
